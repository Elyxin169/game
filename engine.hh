...
//TODO: add all UI objects to the UIObject class
...
namespace tsf
{
      ...
      public:
            ...
            void update()
            {
                  this->shell.setPosition(this->position);
                  this->shell.setFillColor(this->gradient.fillColor);
                  this->shell.setOutlineColor(this->gradient.bordColor);
            }
      ...
      const Gradient TransParent = {sf::Color(69, 69, 69, 0), sf::Color(69, 69, 69, 0)};
      const Gradient Yellow = {sf::Color(184, 184, 26), sf::Color(122, 122, 0)};
